...
type SVGProps = React.SVGProps<SVGSVGElement> & { active?: boolean };

function SvgComponent(
  { active = false, ...rest }: SVGProps,
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <path d={status} fill="currentColor" />
    </svg>
  );
}

const ForwardRef = React.forwardRef(SvgComponent);
const NotificationsIcon = React.memo(ForwardRef);
